    ...
    <PullToRefresh onRefresh={loadData}>
          ...
          {posts.map(post => {
            ...
            return (
              <div key={post.id} className="break-inside-avoid">
                <Card className="bg-[#1a1a1a] border-white/8 overflow-hidden hover:border-white/16 transition-all group">
      ...
      {selectedPost && (
        <Dialog open={!!selectedPost} onOpenChange={() => setSelectedPost(null)}>
          <DialogContent className="bg-[#111111] border-white/10 max-w-4xl max-h-[90vh] overflow-y-auto p-0">
            {/* Image */}
