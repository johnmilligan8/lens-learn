...
const SAMPLE_EVENTS = [
  ...
  { id:'e2', title:'Total Lunar Eclipse (Blood Moon)', type:'lunar_eclipse', date:'2026-03-03', end_date:'2026-03-03', description:"The Moon passes through Earth's full shadow, turning it a deep red/orange — a Blood Moon.", visibility_info:'Visible from North & South America, Western Europe, Africa.', tips:'Use 200–400mm to fill the frame. Bracket exposures from f/5.6 ISO 400 1/250s to ISO 1600 2s.', peak_time:'Mar 3 at 11:30 PM UTC' },
