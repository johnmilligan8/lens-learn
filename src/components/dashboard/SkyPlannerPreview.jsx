...
import { Star, Eye, Telescope, ChevronRight, Zap } from 'lucide-react';
...
export default function SkyPlannerPreview() {
  const [currentObjects] = useState(SAMPLE_OBJECTS);
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <Card className="bg-[#1a1a1a] border border-white/8 hover:border-red-600/40 p-6 relative overflow-hidden group transition-all">
          ...
          <ul className="space-y-1.5 text-xs text-slate-300 mb-4">
            <li className="flex items-center gap-2"><span className="text-red-400">✓</span> Find planets & stars by position</li>
            <li className="flex items-center gap-2"><span className="text-red-400">✓</span> Constellation boundaries</li>
            <li className="flex items-center gap-2"><span className="text-red-400">✓</span> Real-time Alt/Az positioning</li>
          </ul>
        ...
        <Card className="bg-[#1a1a1a] border border-white/8 hover:border-red-600/40 p-6 relative overflow-hidden group transition-all">
          ...
          <ul className="space-y-1.5 text-xs text-slate-300 mb-4">
            <li className="flex items-center gap-2"><span className="text-red-400">✓</span> Search major objects</li>
            <li className="flex items-center gap-2"><span className="text-red-400">✓</span> Altitude & azimuth</li>
            <li className="flex items-center gap-2"><span className="text-red-400">✓</span> Visibility windows</li>
          </ul>
          <Link to={createPageUrl('PaymentGate')} className="block">
            <Button size="sm" className="w-full bg-red-600 hover:bg-red-700">
