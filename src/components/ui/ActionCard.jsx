...
export default function ActionCard({ 
  ...
  const content = (
    <Card className={`bg-[#1a1a1a] border border-white/8 hover:border-red-600/40 p-6 card-glow hover:scale-[1.02] transition-all duration-200 group h-full ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}>
      <div className="bg-red-600/15 p-4 rounded-xl w-fit mb-4">
